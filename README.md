...
2.1  Описание и архитектура нейронной сети. Для сравнительного анализа библиотек глубокого машинного обучения выберем задачу распознавания рукописных цифр из базы данных 
...
2.2.	Программная реализация нейронной сети с использованием различных библиотек. К сожалению мне не удалось воспроизвести описанные ниже модели и повторить опыты с
...
3.1  Установка библиотек.
  ...
  Керас — это:
  росто , но не упрощенно. Keras снижает когнитивную нагрузку разработчика , чтобы вы могли сосредоточиться на тех частях проблемы, которые действительно важны.
